...
{0xFF,2,{0x30,0x02}},
  ...
  {0xce,12,{0x8B,0x03,0x18,0x8A,0x03,0x18,0x89,0x03,0x18,0x88,0x03,0x18,0x00,0x00}},
  ...
  {0xcf,11,{0x3D,0x02,0x15,0x20,0x00,0x00,0x01,0x80,0x00,0x03,0x08}}, //gate pre. ena.
  ...
  {0x00,1,{0x00}},
  {0xE1,20,{0x06,0x13,0x1c,0x29,0x37,0x44,0x47,0x72,0x63,0x7C,0x85,0x6f,0x7F,0x55,0x52,0x42,0x32,0x22,0x19,0x14}},

  {0x00,1,{0x00}},
  {0xE2,20,{0x06,0x13,0x1c,0x29,0x37,0x44,0x47,0x72,0x64,0x7D,0x85,0x6f,0x7F,0x55,0x52,0x43,0x32,0x22,0x19,0x14}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_backporch					= 0x10;// 20   1
    params->dsi.vertical_frontporch					= 0x10; // 1  12
    params->dsi.vertical_active_line				= FRAME_HEIGHT;

    params->dsi.horizontal_sync_active				= 0xa;// 50  2
    params->dsi.horizontal_backporch				= 0x32 ;
    params->dsi.horizontal_frontporch				= 0x32 ;
...
LCM_DRIVER otm1287a_hsd60_hongxian_hd_lcm_drv =
{
    .name			= "otm1287a_hsd60_hongxian_hd",
